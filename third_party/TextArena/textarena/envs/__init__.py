...
# IteratedPrisonersDilemma-Predict: simultaneous broadcast conversation + private prediction phase +
# per-round payoff and prediction bonus emitted as per-step env reward (state.step_info["step_rewards_by_pid"]).
register_with_versions(id="IteratedPrisonersDilemma-Predict-v0", entry_point="textarena.envs.IteratedPrisonersDilemma.env:IteratedPrisonersDilemmaEnv", wrappers={"default": CONVERSATIONAL_WRAPPERS, "-train": CONVERSATIONAL_WRAPPERS}, num_rounds=10, communication_turns=1, cooperate_reward=3, defect_reward=5, sucker_reward=0, mutual_defect_reward=1, enable_broadcast_comm=True, enable_prediction=True, use_step_rewards=True, prediction_reward=1.0)
# IteratedPrisonersDilemma-Broadcast: broadcast conversation + per-round payoff via step rewards,
# no prediction phase. Ablation of -Predict-v0 with enable_prediction=False.
register_with_versions(id="IteratedPrisonersDilemma-Broadcast-v0", entry_point="textarena.envs.IteratedPrisonersDilemma.env:IteratedPrisonersDilemmaEnv", wrappers={"default": CONVERSATIONAL_WRAPPERS, "-train": CONVERSATIONAL_WRAPPERS}, num_rounds=10, communication_turns=1, cooperate_reward=3, defect_reward=5, sucker_reward=0, mutual_defect_reward=1, enable_broadcast_comm=True, enable_prediction=False, use_step_rewards=True, prediction_reward=0.0)
